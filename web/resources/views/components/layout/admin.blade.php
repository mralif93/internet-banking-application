                    ...
                    <div class="pt-2">
                        ...
                        <div class="space-y-1.5 text-xs">
                            <a
                                href="{{ route('customer.dashboard') }}"
                                target="_blank"
                                class="flex items-center justify-between px-3.5 py-2 rounded-2xl text-emerald-700 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-950/40 border border-emerald-200/80 dark:border-emerald-900/40 transition-colors"
                            >
                                <span class="flex items-center gap-2.5">
                                    <i data-lucide="external-link" class="w-4 h-4 text-emerald-600 dark:text-emerald-400"></i>
                                    <span>Retail Web Portal</span>
                                </span>
                                <span class="text-[9px] font-mono font-bold bg-emerald-100 dark:bg-emerald-500/20 text-emerald-800 dark:text-emerald-300 px-1.5 py-0.5 rounded">ONLINE</span>
                            </a>
                            <a
