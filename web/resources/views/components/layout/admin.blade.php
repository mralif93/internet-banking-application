...
<body class="h-full bg-slate-100/80 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans antialiased transition-colors duration-200 flex flex-col min-h-screen selection:bg-rose-600 selection:text-white">

    <!-- ======================================================================
         1. ENTERPRISE ADMIN TOP COMMAND HEADER
         ====================================================================== -->
    <header class="sticky top-0 z-40 w-full bg-slate-900/95 dark:bg-slate-950/95 backdrop-blur-xl text-white border-b border-slate-800/80 shadow-md">
            ...
            <div class="flex items-center justify-between h-16 sm:h-[68px] gap-2.5 sm:gap-4">
                ...
                <div class="flex items-center gap-3 sm:gap-4 min-w-0">
                    ...
                    <button
                        ...
                        class="lg:hidden p-2 rounded-xl text-slate-300 hover:text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-rose-500 cursor-pointer"
                    ...
                    <button
                        ...
                        class="hidden lg:flex p-2 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 focus:outline-none transition-colors cursor-pointer"
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 group shrink-0">
                        <div class="relative w-9.5 h-9.5 sm:w-10.5 sm:h-10.5 rounded-2xl bg-gradient-to-tr from-rose-600 via-rose-700 to-red-800 flex items-center justify-center text-white shadow-md shadow-rose-950/60 group-hover:scale-105 transition-transform shrink-0 ring-1 ring-rose-500/40">
                        ...
                        <div class="flex flex-col min-w-0">
                            <div class="flex items-center gap-2 truncate">
                                ...
                                <span class="text-[9px] uppercase font-mono font-black tracking-wider px-1.5 py-0.5 rounded bg-rose-500/20 text-rose-300 border border-rose-500/30 shrink-0">DEFENSE OPS</span>
                            </div>
                ...
                <div class="hidden md:flex items-center flex-1 max-w-md mx-4">
                    <div class="relative w-full">
                        ...
                        <input
                            ...
                            readonly
                            class="w-full pl-9.5 pr-14 py-2 text-xs rounded-2xl bg-slate-950/70 border border-slate-800 text-slate-300 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-rose-500 transition-all cursor-pointer shadow-inner"
                        />
                ...
                <div class="flex items-center gap-2 sm:gap-3">
                    ...
                    <div class="hidden xl:flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl bg-slate-950/80 border border-slate-800 text-rose-300 text-[11px] font-mono font-bold shadow-inner">
    ...
    <div class="flex-1 flex w-full">
        ...
        <aside
            ...
            class="hidden lg:flex flex-col w-64 xl:w-72 bg-slate-900 text-white border-r border-slate-800/80 transition-all duration-300 ease-in-out shrink-0 sticky top-16 sm:top-[68px] h-[calc(100vh-68px)] select-none z-30"
        >
            <div class="flex-1 flex flex-col justify-between p-4 overflow-y-auto space-y-6">
                
                <div class="space-y-5">
                    <!-- Clearance Status Card -->
                    <div class="p-3.5 rounded-2xl bg-slate-950/80 border border-slate-800 shadow-inner">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="min-w-0 flex-1">
                                <p class="text-xs font-bold text-white truncate">{{ $adminName }}</p>
                                <p class="text-[10px] text-rose-300 font-mono truncate">{{ $adminDepartment }}</p>
                                <p class="text-[10px] text-slate-500 font-mono mt-0.5 truncate">{{ $adminEmployeeId }}</p>
                            </div>
                        </div>
                        <div class="flex items-center justify-between mt-3 pt-2.5 border-t border-slate-800 text-[10px]">
                    ...
                    <nav class="space-y-1 text-xs">
                        <p class="text-[10px] font-black uppercase tracking-wider text-slate-500 px-3 mb-2 font-mono">
                            Administrative Portfolios
                        </p>
                        
                        <a
                            href="{{ route('admin.dashboard') }}"
                            class="flex items-center justify-between px-3.5 py-2.5 rounded-2xl font-bold transition-all group {{ $activeNav === 'fraud' || $activeNav === 'dashboard' ? 'bg-rose-600 text-white shadow-md shadow-rose-950' : 'text-slate-300 hover:text-white hover:bg-slate-800/70' }}"
                        >
                            <div class="flex items-center gap-3">
                                <i data-lucide="activity" class="w-4 h-4 {{ $activeNav === 'fraud' || $activeNav === 'dashboard' ? 'text-white' : 'text-slate-400 group-hover:text-white' }}"></i>
                                <span>Command Center</span>
                            </div>
                        ...
                        <a
                            ...
                            class="flex items-center justify-between px-3.5 py-2.5 rounded-2xl font-bold transition-all group {{ $activeNav === 'parameters' ? 'bg-rose-600 text-white shadow-md shadow-rose-950' : 'text-slate-300 hover:text-white hover:bg-slate-800/70' }}"
                        >
                            <div class="flex items-center gap-3">
                                <i data-lucide="sliders" class="w-4 h-4 {{ $activeNav === 'parameters' ? 'text-white' : 'text-slate-400 group-hover:text-white' }}"></i>
                                <span>System Parameters</span>
                            </div>
                        ...
                        <a
                            ...
                            class="flex items-center justify-between px-3.5 py-2.5 rounded-2xl font-bold transition-all group {{ $activeNav === 'customers' ? 'bg-rose-600 text-white shadow-md shadow-rose-950' : 'text-slate-300 hover:text-white hover:bg-slate-800/70' }}"
                        >
                            <div class="flex items-center gap-3">
                                <i data-lucide="users" class="w-4 h-4 {{ $activeNav === 'customers' ? 'text-white' : 'text-slate-400 group-hover:text-white' }}"></i>
                        ...
                        <a
                            ...
                            class="flex items-center justify-between px-3.5 py-2.5 rounded-2xl font-bold transition-all group {{ $activeNav === 'audit' ? 'bg-rose-600 text-white shadow-md shadow-rose-950' : 'text-slate-300 hover:text-white hover:bg-slate-800/70' }}"
                        >
                            <div class="flex items-center gap-3">
                                <i data-lucide="file-check" class="w-4 h-4 {{ $activeNav === 'audit' ? 'text-white' : 'text-slate-400 group-hover:text-white' }}"></i>
                                <span>Compliance Audit Trail</span>
                            </div>
                            @if($activeNav === 'audit')
                                <span class="w-2 h-2 rounded-full bg-white animate-pulse"></span>
                    ...
                    <div class="pt-2">
                        ...
                        <div class="space-y-1.5 text-xs">
                            <a
                                href="{{ route('customer.dashboard') }}"
                                target="_blank"
                                class="flex items-center justify-between px-3.5 py-2 rounded-2xl text-emerald-400 hover:bg-emerald-950/40 border border-emerald-900/40 transition-colors"
                            >
                                <span class="flex items-center gap-2.5">
                                    <i data-lucide="external-link" class="w-4 h-4"></i>
                                    <span>Retail Web Portal</span>
                                </span>
                                <span class="text-[9px] font-mono font-bold bg-emerald-500/20 px-1.5 py-0.5 rounded">ONLINE</span>
                            </a>
                            <a
                                href="{{ route('admin.parameters') }}#biller-directory-card"
                                class="flex items-center justify-between px-3.5 py-2 rounded-2xl text-slate-300 hover:bg-slate-800/70 transition-colors"
                            >
                                <span class="flex items-center gap-2.5">
                ...
                <div class="pt-4 border-t border-slate-800 space-y-3">
                    <div class="p-3 rounded-2xl bg-slate-950/60 border border-slate-800 text-[11px] space-y-1.5">
                        <div class="flex items-center justify-between">
                            <span class="text-slate-400">Audit Protocol:</span>
                            <span class="font-mono font-bold text-emerald-400">WORM Active</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-slate-400">Encryption:</span>
                            <span class="font-mono text-slate-300">TLS 1.3 / FIPS</span>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.logout') }}">
                        ...
                        <button
                            type="submit"
                            class="w-full flex items-center justify-center gap-2 py-2.5 px-3 rounded-2xl bg-rose-600/15 hover:bg-rose-600 text-rose-400 hover:text-white font-bold text-xs border border-rose-600/30 transition-all cursor-pointer shadow-xs active:scale-98"
                        >
                            <i data-lucide="log-out" class="w-4 h-4"></i>
    ...
    >
        ...
        <div
            ...
            onclick="window.toggleAdminDrawer()"
            class="fixed inset-0 bg-slate-950/80 backdrop-blur-xs transition-opacity duration-300 opacity-0"
        ></div>
        ...
        >
            <div class="space-y-4">
                ...
                <!-- Admin Profile Card -->
                <div class="p-3.5 rounded-2xl bg-slate-950/80 border border-slate-800">
                    <div class="flex items-center gap-3">
                ...
                <nav class="space-y-1 text-sm font-medium">
                    <p class="text-[10px] font-bold text-slate-500 uppercase tracking-wider px-2 mb-1 font-mono">
                        Administrative Portfolios
                    </p>
                    <a
                        href="{{ route('admin.dashboard') }}"
                        onclick="window.toggleAdminDrawer()"
                        class="flex items-center gap-3 px-3.5 py-2.5 rounded-2xl transition-all {{ $activeNav === 'fraud' || $activeNav === 'dashboard' ? 'bg-rose-600 text-white font-bold shadow-md shadow-rose-950' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}"
                    >
                    ...
                    <a
                        href="{{ route('admin.parameters') }}"
                        onclick="window.toggleAdminDrawer()"
                        class="flex items-center gap-3 px-3.5 py-2.5 rounded-2xl transition-all {{ $activeNav === 'parameters' ? 'bg-rose-600 text-white font-bold shadow-md shadow-rose-950' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}"
                    >
                    ...
                    <a
                        href="{{ route('admin.customers') }}"
                        onclick="window.toggleAdminDrawer()"
                        class="flex items-center gap-3 px-3.5 py-2.5 rounded-2xl transition-all {{ $activeNav === 'customers' ? 'bg-rose-600 text-white font-bold shadow-md shadow-rose-950' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}"
                    >
                    ...
                    <a
                        href="{{ route('admin.audit-logs') }}"
                        onclick="window.toggleAdminDrawer()"
                        class="flex items-center gap-3 px-3.5 py-2.5 rounded-2xl transition-all {{ $activeNav === 'audit' ? 'bg-rose-600 text-white font-bold shadow-md shadow-rose-950' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}"
                    >
                    ...
                    <div class="pt-2 border-t border-slate-800">
                        <a
                            href="{{ route('customer.dashboard') }}"
                            target="_blank"
                            class="flex items-center justify-between px-3.5 py-2 rounded-2xl text-xs font-semibold text-emerald-400 hover:bg-slate-800"
                        >
                            <span class="flex items-center gap-2">
                                <i data-lucide="external-link" class="w-4 h-4"></i>
            ...
            <div class="pt-4 border-t border-slate-800">
                <form method="POST" action="{{ route('admin.logout') }}">
                    ...
                    <button
                        type="submit"
                        class="w-full flex items-center justify-center gap-2 py-2.5 px-3 rounded-2xl bg-rose-600/20 text-rose-400 hover:bg-rose-600 hover:text-white font-bold text-xs border border-rose-600/30 transition-all cursor-pointer"
                    >
                        <i data-lucide="log-out" class="w-4 h-4"></i>
    ...
    <div id="admin-command-palette-modal" class="fixed inset-0 z-50 hidden" role="dialog" aria-modal="true">
        <div class="fixed inset-0 bg-slate-950/80 backdrop-blur-xs" onclick="window.closeAdminCommandPalette()"></div>
        <div class="fixed inset-0 flex items-start justify-center pt-16 sm:pt-24 px-4 pointer-events-none">
            <div class="w-full max-w-lg bg-slate-900 border border-slate-800 text-white rounded-3xl shadow-2xl p-4 pointer-events-auto animate__animated animate__fadeInDown animate__faster">
                <div class="flex items-center gap-3 pb-3 border-b border-slate-800">
                    ...
                    <input
                        ...
                        class="w-full bg-transparent text-sm font-semibold text-white placeholder-slate-500 focus:outline-none"
                    />
                    <kbd class="px-1.5 py-0.5 rounded bg-slate-800 text-[10px] font-mono text-slate-400 cursor-pointer" onclick="window.closeAdminCommandPalette()">ESC</kbd>
                </div>
                <div class="py-2 space-y-1 text-xs">
                    <p class="px-2 py-1 text-[10px] font-bold text-slate-500 uppercase font-mono">Quick Navigation</p>
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-3 py-2 rounded-xl text-slate-300 hover:bg-slate-800 hover:text-white transition-colors">
                        <i data-lucide="activity" class="w-4 h-4 text-rose-500"></i>
                        <span>Command Center &amp; AML Radar</span>
                    </a>
                    <a href="{{ route('admin.parameters') }}" class="flex items-center gap-3 px-3 py-2 rounded-xl text-slate-300 hover:bg-slate-800 hover:text-white transition-colors">
                        <i data-lucide="sliders" class="w-4 h-4 text-rose-500"></i>
                        <span>System Parameters Management</span>
                    </a>
                    <a href="{{ route('admin.customers') }}" class="flex items-center gap-3 px-3 py-2 rounded-xl text-slate-300 hover:bg-slate-800 hover:text-white transition-colors">
                        <i data-lucide="users" class="w-4 h-4 text-rose-500"></i>
                        <span>Customer Directory &amp; Account Status</span>
                    </a>
                    <a href="{{ route('admin.audit-logs') }}" class="flex items-center gap-3 px-3 py-2 rounded-xl text-slate-300 hover:bg-slate-800 hover:text-white transition-colors">
                        <i data-lucide="file-check" class="w-4 h-4 text-rose-500"></i>
                        <span>WORM Compliance Audit Logs</span>
                    </a>
                    <a href="{{ route('customer.dashboard') }}" target="_blank" class="flex items-center gap-3 px-3 py-2 rounded-xl text-emerald-400 hover:bg-emerald-950/40 transition-colors">
                        <i data-lucide="external-link" class="w-4 h-4 text-emerald-400"></i>
